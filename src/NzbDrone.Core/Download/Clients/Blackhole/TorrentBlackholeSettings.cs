...
namespace NzbDrone.Core.Download.Clients.Blackhole
{
    ...
    public class TorrentBlackholeSettings : IProviderConfig
    {
        ...
        [FieldDefinition(0, Label = "Torrent Folder", Type = FieldType.Path, HelpText = "Folder in which Bookdarr will store the .torrent file")]
        public string TorrentFolder { get; set; }

        [FieldDefinition(1, Label = "Watch Folder", Type = FieldType.Path, HelpText = "Folder from which Bookdarr should import completed downloads")]
        ...
        [DefaultValue(false)]
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Populate)]
        [FieldDefinition(4, Label = "Read Only", Type = FieldType.Checkbox, HelpText = "Instead of moving files this will instruct Bookdarr to Copy or Hardlink (depending on settings/system configuration)")]
